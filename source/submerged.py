...
def printDispl(x,y,z,Rx,Ry,Rz,filename,figNo,title):
    plt.figure(figNo,figsize=(Globs.imageWidth,Globs.imageHeight), dpi=Globs.imageDPI)
...
def printSlingsCPlate(gTen1,gTen2,gTen3,gTen4,directory,figNo1,figNo2,figNo3,title):
    plt.figure(figNo1,figsize=(Globs.imageWidth,Globs.imageHeight), dpi=Globs.imageDPI)
    plt.suptitle(title,fontsize=14,fontweight='bold')
    ...
    plt.figure(figNo2,figsize=(Globs.imageWidth,Globs.imageHeight), dpi=Globs.imageDPI)
    plt.suptitle(title,fontsize=14,fontweight='bold')
    ...
    plt.figure(figNo3,figsize=(Globs.imageWidth,Globs.imageHeight), dpi=Globs.imageDPI)
    plt.suptitle(title,fontsize=14,fontweight='bold')
...
directory = "E:/STORAGE/ANSYS PROJECTS/H5_0117_Husky_R1/results_submerged/Tp11"
